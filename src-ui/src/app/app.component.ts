  ...
  ngOnInit(): void {
    ...
    this.tourService.initialize([
      ...
      },
      {
        ...
        content: $localize`Drag-and-drop documents here to start uploading or place them in the consume folder. You can also drag-and-drop documents anywhere on all other pages of the web app. Once you do, Smart vOCR will start training its machine learning algorithms.`,
        route: '/dashboard',
        enableBackdrop: true,
        isOptional: true,
        prevBtnTitle,
      ...
      },
      {
        ...
        content:
          ...
          '<br/><br/>' +
          $localize`Lastly, on behalf of every contributor to this community-supported project, thank you for using Smart vOCR!`,
        route: '/dashboard',
        prevBtnTitle,
        nextBtnTitle,
        endBtnTitle,
